...
const BootingAnimation = ({ onComplete }: BootingAnimationProps) => {
  ...
  const bootMessages = [
    ...
    '[ OK ] CLAWCHAN Divine Agent Ready',
  ]
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-background">
      <div className="w-full max-w-2xl px-8">
        ...
        <h1 className="mb-2 text-center font-mono text-2xl font-bold text-foreground">
          CLAWCHAN <span className="text-warm-gold">✦</span> Divine Agent
        </h1>
        <p className="mb-1 text-center font-mono text-xs text-muted-foreground/70">
